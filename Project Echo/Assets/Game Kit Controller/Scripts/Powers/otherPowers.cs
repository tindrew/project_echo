...
public class otherPowers : MonoBehaviour
{
	...
	public projectileInfo setPowerProjectileInfo (Powers selectedPower)
	{
		...
		newProjectile.projectileDamage = selectedPower.projectileDamage * generalAttackDamageMultiplier;
		...
		if (selectedPower.breakThroughObjects) {
			...
			newProjectile.ignoreNewRotationOnProjectileImpact = selectedPower.ignoreNewRotationOnProjectileImpact;
		}
		...
		newProjectile.damageCanBeBlocked = selectedPower.damageCanBeBlocked;
