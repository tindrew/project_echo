...
//				Debug.DrawRay (transform.position, hit.distance * mainCameraTransform.forward, Color.red);
				...
				hitParticles.transform.position = hit.point + 0.02f * (transform.position - hit.point);
