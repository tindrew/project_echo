...
//								}
	...
	public projectileInfo setProjectileInfo ()
	{
		...
		if (currentWeapon.breakThroughObjects) {
			...
			newProjectile.ignoreNewRotationOnProjectileImpact = currentWeapon.ignoreNewRotationOnProjectileImpact;
		}
		...
		newProjectile.damageCanBeBlocked = currentWeapon.damageCanBeBlocked;
