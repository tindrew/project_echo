...
public class health : healthManagement
{
	...
	[TextArea (3, 20)]public string damageTypeExplanation = 
...
//			print ("DESTROYYYYYY health checking if playing");
	...
	void initializeHealthBar ()
	{
		if (settings.useHealthSlider && settings.enemyHealthSlider != null) {
			...
			if (!useHealthbarManager) {
				GKC_Utils.instantiateMainManagerOnSceneWithTypeOnApplicationPlaying (mainManagerName, typeof(healthBarManagementSystem), true);
