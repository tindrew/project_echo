...
//						print (playerTransformDown);
						...
						Debug.DrawRay (hit.point + surfaceOffset * hit.normal, playerTransformDown * 10000, Color.black, 5);
				...
				mainRigidbody.position = Vector3.MoveTowards (mainRigidbody.position, positionToAdjustPlayerToSurfaceCollision, 4 * currentFixedUpdateDeltaTime);
