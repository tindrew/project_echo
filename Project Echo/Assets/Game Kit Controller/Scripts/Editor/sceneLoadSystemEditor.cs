...
{
	SerializedProperty instantiateScenePanelsActivated;
	...
	void OnEnable ()
	{
		instantiateScenePanelsActivated = serializedObject.FindProperty ("instantiateScenePanelsActivated");
	...
	public override void OnInspectorGUI ()
	{
		...
		EditorGUILayout.PropertyField (instantiateScenePanelsActivated);
	...
	void showSceneListElement (SerializedProperty list)
	{
		...
		EditorGUILayout.PropertyField (list.FindPropertyRelative ("sceneButton"));
		GUILayout.EndVertical ();
	}
}
#endif