...
public class IKDrivingSystemEditor : Editor
{
	...
	public void showFreeMoveHandle (Transform currentTransform, string handleName, float handleRadius)
	{
		...
		var fmh_1114_78_638404008000852372 = Quaternion.identity; newFreeHandlePosition = Handles.FreeMoveHandle (currentFreeHandlePosition, handleRadius, snapValue, Handles.CircleHandleCap);
