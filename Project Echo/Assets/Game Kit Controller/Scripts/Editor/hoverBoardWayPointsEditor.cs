			...
			for (int i = 0; i < points.wayPoints.Count; i++) {
				if (points.wayPoints [i].wayPoint != null) {
					...
					if (points.useHandleForVertex) {
						...
						var fmh_88_52_638404007999365376 = Quaternion.identity; newPoint = Handles.FreeMoveHandle (oldPoint, points.handleRadius, new Vector3 (.25f, .25f, .25f), Handles.CircleHandleCap);
