...
public class IKWeaponSystemEditor : Editor
{
	...
	public void showFreeMoveHandle (Transform currentTransform, string handleName, float handleRadius)
	{
		...
		var fmh_966_78_638404008004032909 = Quaternion.identity; newFreeHandlePosition = Handles.FreeMoveHandle (currentFreeHandlePosition, handleRadius, snapValue, Handles.CircleHandleCap);
