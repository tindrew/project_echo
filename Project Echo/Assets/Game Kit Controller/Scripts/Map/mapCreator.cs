...
public class mapCreator : MonoBehaviour
{
	...
	private static mapCreator _mapCreatorInstance;

	public static mapCreator Instance { get { return _mapCreatorInstance; } }
	...
	public void getComponentInstance ()
	{
		...
		if (_mapCreatorInstance != null && _mapCreatorInstance != this) {
			Destroy (this.gameObject);

			return;
		} 

		_mapCreatorInstance = this;
...
//		print (currentTriggerBuilding.name);
	...
	public void setMapObjectInformationID ()
	{
		...
		int mapObjectInformationListLength = mapObjectInformationList.Length;

		for (int j = 0; j < mapObjectInformationListLength; j++) {
			mapObjectInformation mapObjectInfo = mapObjectInformationList [j];
